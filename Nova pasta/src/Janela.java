...
public class Janela extends JFrame 
{
    ...
    protected JButton btnPonto  	 = new JButton ("Ponto"),
            		  ...
            		  btnPoligonoI   = new JButton ("Polígono Irr."),
               		  btnFonte   	 = new JButton ("Fonte"),
               		  btnTexto   	 = new JButton ("Texto"),
                      btnCores   	 = new JButton ("Cor de Contorno"),                      
                      btnCorFundo	 = new JButton ("Cor de Fundo"),
                      btnAbrir  	 = new JButton ("Abrir"),
                      btnSalvar 	 = new JButton ("Salvar"),
                      btnApagar 	 = new JButton ("Apagar"),                     
                      btnSair   	 = new JButton ("Sair");
    
    protected Font fonteAtual =  new javax.swing.plaf.FontUIResource(new Font("MS Mincho",Font.PLAIN, 12));  
    ...
    protected boolean esperaPonto, esperaInicioReta, esperaFimReta, esperaInicioCirculo, 
    					esperaFimCirculo, esperaInicioElipse, esperaFimElipse, esperaInicioQuadrado, esperaFimQuadrado,
    					esperaInicioRetangulo, esperaFimRetangulo, esperaInicioTexto, esperaFimTexto,esperaInicioPoligono, esperaFimPoligono,
    					esperaInicioPoligonoI, esperaFimPoligonoI;
    ...
    public Janela ()
    {
        ...
        {
        	JOptionPane.showMessageDialog(null, 
    									  "Arquivos quadrado.png não foi encontrado",
									  	  "Arquivo de imagem ausente",
    										JOptionPane.WARNING_MESSAGE);
        }
	...
	public MeuJPanel()
                ...
                if (esperaInicioReta)
                {
                    ...
                    statusBar1.setText("Mensagem: clique o ponto final da reta");    
                        ...
                        if (esperaInicioCirculo)
                        {
                            ...
                            if (esperaFimCirculo)
                            {
                            	raio = (int) Math.sqrt((int) Math.pow((e.getX() - p1.getX()), 2) + (int) Math.pow((e.getY() - p1.getY()), 2));
                                ...
                                if (esperaInicioElipse)
                                {
                                    ...
                                    statusBar1.setText("Mensagem: clique o ponto final do elipse");       
                                 }   
                                else
                                    if (esperaFimElipse)
                                    {
                                                ...
                                                if (esperaInicioRetangulo)
                                                {
                                                    ...
                                                    {                                                    	
                                                        ...
                                                        {                                                        	
                                                            ...
                                                            statusBar1.setText("Mensagem: clique o ponto para definir a largura dos lados");       
                                                         }  
                                                        else
		                						        	...
		                						        	{                    		
		                						        		...
		                						        		statusBar1.setText("Mensagem: Clique fora da caixa de Texto para Concluir!");
			                										...
			                										if(esperaFimTexto)
			                										{			                											
			                										texto.setFont(new Font(fonte.getSelectedFontFamily(), fonte.getSelectedFontStyle(), fonte.getSelectedFontSize()));
			                						        		String txt = texto.getText();                    				        	
			                						        		
			                										texto.setBackground(getBackground());
			                						        		texto.setForeground(corAtual);
			                						        		setLayout(new BorderLayout());	
			                						        		getGraphics().clearRect(pnlDesenho.getX(), pnlDesenho.getY(), pnlDesenho.getWidth(), pnlDesenho.getHeight());
        ...
        public void mouseDragged(MouseEvent e)
        {
                 ...
                 Linha linha =  new Linha(p1.getX(), p1.getY(), e.getX(), e.getY(), corAtual);
    ...
    protected class DesenhoPoligono implements ActionListener
    {
    	public void actionPerformed (ActionEvent e)
    	{
            ...
            ladosPoligono = Integer.parseInt((JOptionPane.showInputDialog(pnlDesenho, "Quantos lados o polígono deve ter?", null)));
    		...
    		try
    		{
    			PrintWriter arqSaida = new PrintWriter (
                        new FileOutputStream (
                                "C:/Users/Pedro/Desktop/teste.txt"));;

...
public class Linha extends Figura {
	...
	public String toString() {
		return "l:" + this.p1.getX() + ":" + this.p1.getY() + ":" + this.p2.getX() + ":" + this.p2.getY() + ":"
	...
	public int hashCode() {
		...
		ret = ret * 7 + new Integer(this.p1.getX()).hashCode();
		ret = ret * 7 + new Integer(this.p1.getY()).hashCode();
		ret = ret * 7 + new Integer(this.p2.getX()).hashCode();
		ret = ret * 7 + new Integer(this.p2.getY()).hashCode();

...
public class Poligono extends Figura {
	...
	public Poligono(int[] x, int[] y, int pontos) {
		this(x, y, pontos, Color.BLACK, Color.WHITE);
	}

	public Poligono(int[] x, int[] y, int pontos, Color cor, Color corFundo) {
		super(cor);
		this.pontosX = x;
		this.pontosY = y;
		this.nPontos = pontos;
	...
	public Poligono(Poligono modelo) throws Exception {
		if (modelo == null)
